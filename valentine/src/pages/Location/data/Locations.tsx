...
export const visitedPlaces = [
    ...
    { name: "The parrots", description: "How many parros in this picture ?", coords: [51.52750850360358, -0.1517586956821739], image: howManyParrots},
    ...
    // Florence
    { name: "Florence", description: "Sunsets and sunrises, they don't compare to your smile",  coords: [43.769290967255344, 11.253670373799066] },
    ...
    // Tallinn
    { name: "Tallinn", description: "Where it all just made sense", coords: [59.43693717805752, 24.756926457463138] },
    { name: "My home", description: "Tiramisu', napping, hugging and kissing, so many memories !", coords: [59.42545741058523, 24.73752022371597] },
    { name: "Möku", description: "Your first espresso martini !", coords: [59.44035875342937, 24.728765015923983] },
    { name: "F-Hoone", description: "", coords: [59.43957005140575, 24.729089782322166] },
    { name: "", description: "Looking for bathrooms !", coords: [59.44383909377067, 24.758079915010224] },
    { name: "Tallinn Port", description: "Finland, but why !", coords: [59.44472012421977, 24.761987646695943] },
    { name: "Baltic sea", description: "Sneaky pics, lots of love", coords: [59.603915346469236, 24.683187345444104] },
    { name: "Pho lunch", description: "Polite good", coords: [59.431927262600446, 24.746391729415276] },
    { name: "Dumplings were... interesting", description: "The cake was good", coords: [59.42384846094173, 24.74277140253224] },
    { name: "Viru bog", description: "In the woods, with the best company", coords: [59.46502796416673, 25.63888110210818] },
    { name: "Viru bog", description: "Sunset, snow, and the most beautiful smile", coords: [59.4687343982517, 25.655060187001272] },
    { name: "Viru bog", description: "My favourite picture of us !", coords: [59.47016580936945, 25.66044956459359] },
    { name: "Steaks and smiles", description: "FOOOOOOOOOOD", coords: [59.442558820639704, 24.733699252171956] },
    { name: "Stephen", description: "Stephen", coords: [59.4425425391391, 24.777939874947908] },
    { name: ".... WHYYYYYy", description: "Really ? ...", coords: [59.42584387726853, 24.736639796201782] },
    ...
    { name: "Church !", description: "Looks badass", coords: [60.17069240414722, 24.952346885265012] },
    { name: "Kiasma", description: "Architecture students !", coords: [60.171591075033184, 24.937239908019286] },
    { name: "Doge", description: "Best thing out of Finland", coords: [60.17174906326815, 24.936739869164633] },
    { name: "Ramen!", description: "Politely good", coords: [60.166514196709194, 24.93324884246111] },
    { name: "Gattos", description: "My cat looks better 😎", coords: [60.163126516547365, 24.946726471771054] },
